...
public abstract class ConstraintsBuilder {
    ...
    public abstract ConstraintsBuilder camera(String camera);
    ...
    private static final class CppProxy extends ConstraintsBuilder {
        ...
        @Override
        public ConstraintsBuilder camera(String camera) {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            return native_camera(this.nativeRef, camera);
        }

        private native ConstraintsBuilder native_camera(long _nativeRef, String camera);
