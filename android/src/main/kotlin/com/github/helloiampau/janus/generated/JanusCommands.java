...
public final class JanusCommands {
    ...
    public static final String ROOM_CREATE = "AhugLy7lg2";

    public static final String ROOM_DESTROY = "bhugLy7lg3";
    ...
    public static final String UNPUBLISH = "uL52vhlgFC";

    public static final String SUBSCRIBE = "TzSW9zCWDl";

    public static final String UNSUBSCRIBE = "TzSW9zCWEm";
    ...
    public static final String LEAVE = "ZleGo5pJm0";
