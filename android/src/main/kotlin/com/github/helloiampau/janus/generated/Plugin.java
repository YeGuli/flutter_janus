...
public abstract class Plugin {
    ...
    public abstract void onHangup(long sender, String reason);
    ...
    private static final class CppProxy extends Plugin {
        ...
        @Override
        public void onHangup(long sender, String reason) {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_onHangup(this.nativeRef, sender, reason);
        }

        private native void native_onHangup(long _nativeRef, long sender, String reason);
